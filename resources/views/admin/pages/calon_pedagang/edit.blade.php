        ...
        <div class="container mt-3">
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" action="{{ route('konfirmasi.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="col-md-6">
                    <label for="nama_pasar" class="form-label">Nama Pasar *</label>
                    <input type="text" name="nama_pasar" readonly class="form-control" id="staticEmail" value="{{ Auth::user()->name }}">
                ...
                <div class="col-md-6">
                  ...
                  <input readonly type="text" class="form-control"  id="jenis_tempat" name="jenis_tempat" value="{{ old('judul', $data->jenis_tempat) }}">
                ...
                <div class="col-md-6">
                    ...
                    <input readonly type="text" class="form-control"  id="ukuran_tempat" name="ukuran_tempat" value="{{ old('judul', $data->ukuran_tempat) }}">
                ...
                <div class="col-md-6">
                    ...
                    <input readonly type="text" class="form-control"  id="nomor_tempat" name="nomor_tempat" value="{{ old('judul', $data->nomor_tempat) }}">
                ...
                <div class="col-md-6">
                  ...
                  <input readonly type="text" class="form-control"  id="jenis_jualan" name="jenis_jualan" value="{{ old('judul', $data->jenis_jualan) }}">
                </div>
                <div class="col-md-6">
                    <label for="nama" class="form-label">Nama *</label>
                    <input readonly type="text" id="nama" name="nama" class="form-control" value="{{ old('judul', $data->nama) }}">
                </div>
                <div class="col-md-6">
                    <label for="nik" class="form-label">NIK *</label>
                    <input readonly type="number" id="nik" name="nik" class="form-control" value="{{ old('judul', $data->nik) }}">
                </div>
                  <div class="col-md-6">
                    <label for="tanggal_lahir" class="form-label">Tanggal Lahir *</label>
                    <input readonly type="date" id="tanggal_lahir" name="tanggal_lahir" class="form-control" value="{{ old('judul', $data->tanggal_lahir) }}">
                  </div>
                <div class="col-md-6">
                    <label for="jenis_kelamin" class="form-label">Jenis Kelamin</label>
                    <input readonly type="text" id="jenis_kelamin" name="jenis_kelamin" class="form-control" value="{{ old('judul', $data->jenis_kelamin) }}">
                </div>
                <div class="col-md-6">
                  <label for="nomor_hp" class="form-label">Nomor Ponsel *</label>
                  <input readonly type="number" class="form-control" placeholder="Nomor Ponsel" id="nomor_hp" name="nomor_hp" value="{{ old('judul', $data->nomor_hp) }}">
                </div>
                <div>
                    <div class="row mb-3">
                        <label for="alamat" class="col-sm-2 col-form-label">Alamat *</label>
                        <div class="col-sm-10">
                            <textarea readonly class="form-control" style="height: 100px"  id="alamat" name="alamat">{{ old('judul', $data->alamat) }}</textarea>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
            ...
            <a href="{{ url('konfirmasi') }}" class="btn btn-secondary"><i class="bi bi-arrow-left"></i>Kembali</a>
            </div>
            </div>
